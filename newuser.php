...
<head>
    <meta charset="UTF-8">
    <title>Registrarse Admin - Books</title>
...
<body>
    <div class="form--books">
        ...
        <form action="funciones.php" method="post">
            ...
            <input class="input-field" id="nombre" name="nombre" placeholder="Nombre" type="text" size="18" required="required" />
            </div>
            <div class="input--base">
            <input class="input-field" id="email" name="email" placeholder="Email" type="text" size="18" required="required" />
            </div>
            <div class="input--base">
            <input class="input-field" id="usuario" name="usuario" placeholder="Usuario" type="text" size="18" required="required" />
            </div>
            <div class="input--base">
            <input class="input-field" id="password" name="password" placeholder="Password" type="password" size="18" required="required" />
            </div>
            <input class="registrarme" type="submit" name="newUser" value="Registrar">
            <br><center>
				<?php 
