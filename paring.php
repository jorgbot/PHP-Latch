...
<body>
    <div class="form--books">
        ...
        <form action="funciones.php" method="post">
            ...
            <input class="input-field" name="codigo_pareo" placeholder="Codigo de pareo" type="text" size="18" />
            </div>
            <input class="ingresar" type="submit" name="paring" value="Parear con Latch">
            <input class="registrarme" type="submit" name="omitir" value="Omitir">
            <br><center>
				<?php 
